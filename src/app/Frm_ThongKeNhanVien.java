...
public class Frm_ThongKeNhanVien extends JFrame{
	...
	private void gui() {
		...
		JLabel lbltknv = new JLabel("THỐNG KÊ NHÂN VIÊN");
		...
		dateChooserThongKeNgayBatDau.getCalendarButton().setIcon(new ImageIcon(Frm_ThongKeNhanVien.class.getResource("/imgs/calendar.png")));
		...
		dateChooserThongKeNgayBatDau.setIcon(new ImageIcon(Frm_ThongKeNhanVien.class.getResource("/imgs/calendar.png")));
		...
		dateChooserThongKeNgayKetThuc.setIcon(new ImageIcon(Frm_ThongKeNhanVien.class.getResource("/imgs/calendar.png")));
		...
		JLabel lblthongke1 = new JLabel("Tổng số nhân viên: ");
		...
		JLabel lblthongke2 = new JLabel("Tổng số hóa đơn nhân viên đã lập:");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"M\u00E3 NV", "H\u1ECD v\u00E0 t\u00EAn", "N\u0103m sinh", "CCCD", "Gi\u1EDBi t\u00EDnh", "\u0110\u1ECBa ch\u1EC9", "SDT", "Ch\u1EE9c v\u1EE5"
			}
		));
